            ...
            >
                ...
                <div className="mb-8">
                    ...
                    <div className="space-y-4">
                        <a href="https://cambrean.com" target="_blank" rel="noopener noreferrer" className="flex items-center cursor-auto space-x-4 mt-4 transition-colors duration-150 hover:bg-gray-100 p-2 rounded-xl">
